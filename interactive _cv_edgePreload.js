...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "http://www.edgehero.com/edgehero.js/1.1/edgehero_1.1_min.js", user: true },
      { load: "interactive%20_cv_edge.js"},
      { load: "interactive%20_cv_edgeActions.js"}];
...
var plSTF="height",ctrPlS="none",minPlW="0px",maxPlW=undefined,plWidth="10000px",plHeight="768px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['214px', '349px','600px','52px','auto', 'auto'],
